...
public class GameScreen extends ScreenAdapter{
    ...
    static final float GUI_HEIGHT = 400;
    ...
    int mHighScore;
    Preferences mPrefs;
    public Sound sound = Gdx.audio.newSound(Gdx.files.internal("explosion2.mp3"));
    ...
    public  GameScreen(JumpActionGame game){
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.shuuhei.sutou.jumpactiongame");
    ...
    private void createsStage(){
        Texture stepTexture = new Texture("step.png");
        Texture starTexture = new Texture("star.png");
        Texture playTexture = new Texture("uma.png");
        Texture ufoTexture = new Texture("ufo.png");
        Texture enemyTexture = new Texture("enemy2.jpeg");
        ...
        while (y < WORLD_HEIGHT -5){
            ...
            if(mRandom.nextFloat() > 0.6f){
                Enemy enemy = new Enemy(enemyTexture, 0, 0, 225, 225);
                enemy.setPosition(step.getX() + mRandom.nextFloat(), step.getY() + Enemy.STAR_HEIGHT + mRandom.nextFloat() * 3);
                mEnemys.add(enemy);
        ...
        mPlayer = new Player(playTexture, 0, 0, 72, 72);
    ...
    private void checkGameOverEnemy(Enemy enemy){
    ...
    private void checkCollision(){
        ...
        for (int i = 0; i < mEnemys.size(); i++){
            ...
            if(enemy.mState == Enemy.STAR_NONE){
                continue;
            }

            checkGameOverEnemy(enemy);
        }
